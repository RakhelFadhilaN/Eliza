...
class ElizaBot:
    def __init__(self):
        ...
        self.responses_set_27 = [
            "You're welcome! Feel free to ask me more and get well soon!"
        ]

        self.responses_set_28 = [
        ...
        self.patterns_responses = [
            ...
            ([re.compile(r'thankyou', re.IGNORECASE),
              re.compile(r'thank you', re.IGNORECASE)], self.responses_set_27),

            ([re.compile(r'(.*)', re.IGNORECASE)], self.responses_set_28)
        ]
...
while True:
    ...
    if user_input.lower() == "quit":
        print("It was nice talking to you. Take care of yourself and get well soon.")
        break
